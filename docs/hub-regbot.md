...
- CLI Reference: [regclient.org/cli/regbot/](https://regclient.org/cli/regbot/)
...
- `regclient/regbot:latest`: Most recent release based on scratch.
- `regclient/regbot:alpine`: Most recent release based on alpine.
- `regclient/regbot:edge`: Most recent commit to the main branch based on scratch.
- `regclient/regbot:edge-alpine`: Most recent commit to the main branch based on alpine.
- `regclient/regbot:$ver`: Specific release based on scratch (see below for semver details).
- `regclient/regbot:$ver-alpine`: Specific release based on alpine (see below for semver details).
