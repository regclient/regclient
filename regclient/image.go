...
func (rc *Client) ImageCopy(ctx context.Context, refSrc types.Ref, refTgt types.Ref, opts ...ImageOpts) error {
	var opt imageOpt
...
func (rc *Client) imageCopyOpt(ctx context.Context, refSrc types.Ref, refTgt types.Ref, opt *imageOpt) error {
...
func (rc *Client) ImageExport(ctx context.Context, ref types.Ref, outStream io.Writer) error {
...
func (rc *Client) imageExportDescriptor(ctx context.Context, ref types.Ref, desc ociv1.Descriptor, twd *tarWriteData) error {
...
func (rc *Client) ImageImport(ctx context.Context, ref types.Ref, rs io.ReadSeeker) error {
	trd := &tarReadData{
		handlers:  map[string]tarFileHandler{},
		processed: map[string]bool{},
		finish:    []func() error{},
...
func (rc *Client) imageImportBlob(ctx context.Context, ref types.Ref, desc ociv1.Descriptor, trd *tarReadData) error {
...
func (rc *Client) imageImportDockerAddHandler(trd *tarReadData) {
...
func (rc *Client) imageImportDockerAddLayerHandlers(ctx context.Context, ref types.Ref, trd *tarReadData) {
...
func (rc *Client) imageImportOCIAddHandler(ctx context.Context, ref types.Ref, trd *tarReadData) {
	// add handler for oci-layout, index.json, and manifest.json
	var err error
...
func (rc *Client) imageImportOCIHandleManifest(ctx context.Context, ref types.Ref, m manifest.Manifest, trd *tarReadData, push bool) error {
...
func (rc *Client) imageImportOCIPushManifests(ctx context.Context, ref types.Ref, trd *tarReadData) error {
